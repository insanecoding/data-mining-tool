...
//    }
//
//    public void generateBaseLearnersScheme(Experiment experiment, int categoryNum, String categoryName) {
//        try {
...
//    public void generateStackingScheme(Experiment experiment, int categoriesAmount) {
//        String fixedExpName = experiment.getExpName().replaceAll("[^A-Z0-9a-z]", "");
//        try {
...
//    }
//
//    public void generateApplyModelScheme(Experiment experiment) {
//        String fixedExpName = experiment.getExpName().replaceAll("[^A-Z0-9a-z]", "");
//        try {
